...
svmfit = svm(y.train~., data = dat , type = "C-classification" , kernel = "radial", gamma = 1, cost = 1)
summary(svmfit)
```
...
out <-  tune(svm, y.train~., data = dat, kernel = "radial",ranges = list(cost = c(0.001, 0.01,1,10,100)))
# extract the best model
bestmod <- out$best.model
```
